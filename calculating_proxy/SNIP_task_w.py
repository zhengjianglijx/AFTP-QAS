...
class SnipCalculator:
    ...
    def Snip_calculator(self, circuits, inputs_bounds, weights_bounds):
        tf.random.set_seed(self.seed)
        np.random.seed(self.seed)
        snip = []
...
if __name__ == '__main__':
    ...
    parser.add_argument("--task", type=str, default='Classification', help="task")
    ...
    Sc = SnipCalculator(args, noise_param=noise_param)
    snip = Sc.Snip_calculator(list_cir, input_bounds, weights_bounds)
    print('a')
